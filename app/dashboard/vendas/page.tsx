...
export default function VendasPage() {
    ...
    return (
        <>
            ...
            <VendaForm isOpen={isFormOpen} onOpenChange={setIsFormOpen} vendaToEdit={vendaToEdit} />
            ...
            <motion.div className="space-y-6" initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
                ...
                <VendasTable vendas={vendasEnriquecidas} onEdit={handleEdit} onPrepareNFe={handlePrepareNFe} isReadOnly={isReadOnly} />
            </motion.div>
        </>
    );
}
